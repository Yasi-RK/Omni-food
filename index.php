...
<html lang="en">
    <head>
        ...
        <meta name="description" content="Omni food is perimum food delivery servis">
        <link rel="stylesheet" href="data/css/normalize.css" type="text/css">
        <link rel="stylesheet" href="data/css/grid.css" type="text/css">
        <link rel="stylesheet" href="css/style.css" type="text/css">
        <link rel="stylesheet" href="css/quary.css" type="text/css">
        ...
        >
        <link rel="manifest" href="data/favicon/android-chrome-512x512.png">
    </head>
    <body>
        <header class="js--start">
            <nav>
                <div class="row">
                    <img src="css/images/logo-white.png" alt="Omni food logo" class="logo">
                    <img src="css/images/logo.png" alt="Omni food logo" class="logo-black">
                    <ul class="main-nav js--main-nav">
                        <li>
                            <a href="#feature">Food delivery</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="#plans">Sing up</a>
                        </li>
                    </ul>
                    <a class="mobile-nav-icon js--nav-icon">
                        <ion-icon name="menu" class="open-menu"></ion-icon>
                        <ion-icon name="close" class="close-menu"></ion-icon>
                    </a>
                </div>
            </nav>
        ...
        <section class="section-futures js--section-futures" id="feature">
            <div class="row">
            ...
            <div class="row js--wp-1">
                <div class="col span-1-of-4 box">
                    ...
                    <p>
                        Never cook again! We really mean that. Our subscription
                            plans include up to 365 days/year coverage. You can also choose to order more flexibly if that's your style.
                    </p>
                </div>
                <div class="col span-1-of-4 box">
                ...
                <div class="col span-1-of-4 box">
                    <ion-icon name="paper" class="icon-big"></ion-icon>
            ...
            <ul class="meals-showcase clearfix">
                <li>
                    <figure class="meal-photo">
                        <img src="css/images/1.jpg" alt="Korean bibimbap with egg and vegetables">
                    </figure>
                </li>
                <li>
                    <figure class="meal-photo">
                        <img src="css/images/2.jpg" alt="Simple italian pizza with cherry tomatoes">
                    </figure>
                </li>
                <li>
                    <figure class="meal-photo">
                        <img src="css/images/3.jpg" alt="Chicken breast steak with vegetabless">
                    </figure>
                </li>
                <li>
                    <figure class="meal-photo">
                        <img src="css/images/4.jpg" alt="Autumn pumpkin soup">
                    </figure>
                </li>
            </ul>
            <ul class="meals-showcase clearfix">
                <li>
                    <figure class="meal-photo">
                        <img src="css/images/5.jpg" alt="Paleo beef steak with vegetables">
                    </figure>
                </li>
                <li>
                    <figure class="meal-photo">
                        <img src="css/images/6.jpg" alt="Healthy baguette with egg and vegetables">
                    </figure>
                </li>
                <li>
                    <figure class="meal-photo">
                        <img src="css/images/7.jpg" alt="Burger with cheddar and bacon">
                    </figure>
                </li>
                <li>
                    <figure class="meal-photo">
                        <img src="css/images/8.jpg" alt="Granola with cherries and strawberries">
                    </figure>
                </li>
            </ul>
        </section>
        <section class="section-steps" id="works">
            ...
            <div class="row">
                <div class="col span-1-of-2 steps-box">
                    <img src="css/images/app-iPhone.png" alt="Omni food app on iphone" class="app-screen js--wp-2">
                </div>
                <div class="col span-1-of-2 steps-box">
                    ...
                    <div class="appstore">
                        <a href="#" class="btn-app">
                            <img src="css/images/app-store.png" alt="App Store Button">
                        </a>
                        <a href="#" class="btn-app">
                            <img src="css/images/download-app-android.png" alt="Play Store Button">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    <img src="css/images/lisbon-3.jpg" alt="Lisbon">
                    <h3>Lisbon</h3>
                ...
                <div class="col span-1-of-4 box">
                    <img src="css/images/san-francisco.jpg" alt="san francisco">
                    <h3>San Francisco</h3>
                    <div class="city-future">
                        <ion-icon name="person" class="icon-small"></ion-icon>
                        3700+ happy eaters
                ...
                <div class="col span-1-of-4 box">
                    <img src="css/images/berlin.jpg" alt="Berlin">
                    <h3>Berlin</h3>
                    <div class="city-future">
                        <ion-icon name="person" class="icon-small"></ion-icon>
                        2300+ happy eaters
                ...
                <div class="col span-1-of-4 box">
                    <img src="css/images/london.jpg" alt="London">
                    <h3>London</h3>
                    <div class="city-future">
                        <ion-icon name="person" class="icon-small"></ion-icon>
                        1200+ happy eaters
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite>
                            <img src="css/images/customer-1.jpg">
                            Alberto Duncan
                        </cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite>
                            <img src="css/images/customer-2.jpg">
                            Joana Silva
                        </cite>
                    </blockquote>
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite>
                            <img src="css/images/customer-3.jpg">
                            Milton Chapman
                        </cite>
                    </blockquote>
                </div>
                    ...
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                ...
                                <li>
                                    <ion-icon name="close" class="icon-small"></ion-icon>
                                </li>
                                <li>
                                    <ion-icon name="checkmark" class="icon-small"></ion-icon>
                                    Free delivery
        ...
        <div class="go-to-top-btn">
            <input type="submit" value="Go to Start!" class="js--go-to-start">
        </div>
        <footer>
            <div class="row social-elements">
                ...
                <div class="col span-1-of-2 social">
        ...
        <script src="data/js/jquery.waypoints.min.js"></script>
